...
static void build_node_4(FildeshSxpb* sxpb, FildeshSxpbIT it) {
...
static void build_node_7(FildeshSxpb* sxpb, FildeshSxpbIT it) {
...
static void build_node_11(FildeshSxpb* sxpb, FildeshSxpbIT it) {
...
static void build_node_10(FildeshSxpb* sxpb, FildeshSxpbIT it) {
...
static void build_node_3(FildeshSxpb* sxpb, FildeshSxpbIT it) {
...
static void build_node_15(FildeshSxpb* sxpb, FildeshSxpbIT it) {
...
static void build_node_20(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "value", 5), FildeshSxprotoFieldKind_LITERAL);
...
static void build_node_26(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "value", 5), FildeshSxprotoFieldKind_LITERAL);
...
static void build_node_25(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "div", 3), FildeshSxprotoFieldKind_MANYOF);
  build_node_26(sxpb, it);
}

static void build_node_14(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "add", 3), FildeshSxprotoFieldKind_MANYOF);
  build_node_15(sxpb, it);
  it = direct_insert_next_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "mul", 3), FildeshSxprotoFieldKind_MANYOF);
  build_node_20(sxpb, it);
  it = direct_insert_next_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "neg", 3), FildeshSxprotoFieldKind_MESSAGE);
  build_node_25(sxpb, it);
}

static void build_node_34(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "value", 5), FildeshSxprotoFieldKind_LITERAL);
  direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "+1", 2), FildeshSxprotoFieldKind_LITERAL_INT);
}

static void build_node_37(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "value", 5), FildeshSxprotoFieldKind_LITERAL);
  direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "+2", 2), FildeshSxprotoFieldKind_LITERAL_INT);
}

static void build_node_33(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_34(sxpb, it);
  it = direct_insert_next_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_37(sxpb, it);
}

static void build_node_32(FildeshSxpb* sxpb, FildeshSxpbIT it) {
...
static void build_node_42(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "value", 5), FildeshSxprotoFieldKind_LITERAL);
  direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "+3", 2), FildeshSxprotoFieldKind_LITERAL_INT);
}

static void build_node_45(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "value", 5), FildeshSxprotoFieldKind_LITERAL);
  direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "+4", 2), FildeshSxprotoFieldKind_LITERAL_INT);
}

static void build_node_41(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_42(sxpb, it);
  it = direct_insert_next_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_45(sxpb, it);
}

static void build_node_40(FildeshSxpb* sxpb, FildeshSxpbIT it) {
...
static void build_node_51(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "value", 5), FildeshSxprotoFieldKind_LITERAL);
  direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "+56", 3), FildeshSxprotoFieldKind_LITERAL_INT);
}

static void build_node_54(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "value", 5), FildeshSxprotoFieldKind_LITERAL);
  direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "+7", 2), FildeshSxprotoFieldKind_LITERAL_INT);
}

static void build_node_50(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_51(sxpb, it);
  it = direct_insert_next_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_54(sxpb, it);
}

static void build_node_49(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "div", 3), FildeshSxprotoFieldKind_ARRAY);
  build_node_50(sxpb, it);
}

static void build_node_48(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "neg", 3), FildeshSxprotoFieldKind_MESSAGE);
  build_node_49(sxpb, it);
}

static void build_node_31(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_32(sxpb, it);
  it = direct_insert_next_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_40(sxpb, it);
  it = direct_insert_next_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "", 0), FildeshSxprotoFieldKind_MESSAGE);
  build_node_48(sxpb, it);
}

static void build_node_2(FildeshSxpb* sxpb, FildeshSxpbIT it) {
  it = direct_insert_first_FildeshSxpb(sxpb, it, ensure_name_FildeshSxpb(sxpb, "add", 3), FildeshSxprotoFieldKind_MANYOF);
  build_node_3(sxpb, it);
